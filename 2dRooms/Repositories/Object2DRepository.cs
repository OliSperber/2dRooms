...
public class Object2DRepository : SqlService, IObject2DRepository
{
    ...
    {
        var query = "SELECT * FROM Object2Ds WHERE EnvironmentId = @EnvironmentId";
    ...
    {
        var query = "SELECT * FROM Object2Ds WHERE Id = @Id";
        using (var connection = CreateConnection())
        {
    ...
    {
        var query = "INSERT INTO Object2Ds (Id, PrefabId, PositionX, PositionY, ScaleX, ScaleY, RotationZ, SortingLayer, EnvironmentId) " +
    ...
    {
        var query = "UPDATE Object2Ds SET PrefabId = @PrefabId, PositionX = @PositionX, PositionY = @PositionY, " +
    ...
    {
        var query = "DELETE FROM Object2Ds WHERE Id = @Id";
        using (var connection = CreateConnection())
        {
